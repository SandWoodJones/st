...
/* Fallback fonts */
static char *font2[] = {
	"Inconsolata Nerd Font:size=13:antialias=true:autohint=true"
};
...
static const char *colorname[] = {
	...
	"#000503", // default focused background
	"#000003", // default unfocused background
	"#FFFFFF", // default cursor
	"#000000"  // inverse cursor
};
...
/*
 * https://invisible-island.net/xterm/ctlseqs/ctlseqs.html#h4-Functions-using-CSI-_-ordered-by-the-final-character-paren-s-rparen:CSI-Ps-SP-q.1D81
